...
export const news: NewsResponseDTO[] = [
  {
    id: 1,
    title: 'Esta es una prueba para el titulo de la novedad tambien podemos estar',
    contentToShow: 'esta es el contenido que se va ver en la descripcion visible, esta es el contenido que se va ver en la' + 
                  ...
                  'va ver en la descripcion visible esta es el contenido',
    content: 'te veo poco, pero te pienso mucho Cada vez que intento evadirme de ti dejando de verte, a los segundos invades mi mente.' +
              ...
              'y mi libro favorito son todos tus mensajes. Quiero huir de ti, pero también quiero que corriendo vengas a buscarme.' + 
              'Cómo esperas que te olvide, si cuando empiezo a olvidarte, me olvido de olvidarte y comienzo a recordarte.' + 
              'Tienes algo que me encanta, que me hace vibrar, que me llena el corazón de alegría y una felicidad inmensa' +
